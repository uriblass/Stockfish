...
namespace {
  ...
  const Score MobilityBonus[][32] = {
     {}, {},
     { S(-35,-30), S(-15,-12), S(-2,-1), S( 10,9), S(21, 18), S(31, 26), // Knights
       S( 40, 33), S( 40, 33), S(40, 33) },
     { S(-22,-27), S( -4,-9), S( 12,  7), S(26, 21), S(40, 35), S(54, 49), // Bishops
       S( 66, 61), S( 74, 69), S(80, 74), S(85, 79), S(89, 83), S(92, 87),
       S( 95, 90), S( 98, 93), S(99, 94), S(99, 94) },
     { S(-17,-33), S(-8,-12), S(0,  6), S( 7, 23), S( 14, 39), S(20, 55), // Rooks
       S( 26, 70), S( 31, 85), S(35, 99), S(38,112), S(41,123), S(44,129),
       S( 47,134), S( 48,135), S(49,136), S(50,136) },
     { S(-24,-28), S( -14,-17), S(-5, -7), S(3, 2), S( 10,  11), S( 16, 20), // Queens
       S(  21, 28), S( 25, 35), S(29, 41), S(32, 46), S(34, 50), S(35, 52),
       S( 36, 53), S( 36, 53), S(36, 53), S(36, 53), S(36, 53), S(36, 53),
       S( 36, 53), S( 36, 53), S(36, 53), S(36, 53), S(36, 53), S(36, 53),
       S( 36, 53), S( 36, 53), S(36, 53), S(36, 53), S(36, 53), S(36, 53),
       S( 36, 53), S( 36, 53) }
  };
