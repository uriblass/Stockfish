...
namespace {
  ...
  // by friendly pieces.
  //did some reduction in MobilityBonus
   
  
  const Score MobilityBonus[][32] = {
     {}, {},
     { S(-41,-36), S(-28,-26), S(-15,-16), S( -3, -6), S(9,  4), S(21, 14), // Knights
       S( 31, 22), S( 36, 25), S( 38, 27) },
     { S(-28,-33), S(-14,-19), S(  0, -5), S(14, 9), S(28, 23), S(42, 37), // Bishops
       S( 54, 49), S( 62, 57), S( 68, 62), S(71, 66), S(74, 69), S(76, 71),
       S( 78, 73), S( 80, 75), S( 81, 76), S(81, 76) },
     { S(-23,-39), S(-17,-22), S( -11, -6), S(-5, 10), S( 1, 26), S(7, 42), // Rooks
       S( 12, 58), S( 16, 74), S( 20, 90), S(23,103), S(25,109), S(27,113),
       S( 29,116), S( 30,117), S( 31,118), S(32,118) },
     { S(-18,-26), S( -14,-19), S( -11, -13), S(-8, -7), S(-5, -1), S( -2,  5), // Queens
       S(  1, 11), S(  4, 17), S(  7, 23), S(10, 28), S(12, 32), S(14, 34),
       S( 16, 35), S( 17, 35), S( 18, 35), S(19, 35), S(20, 35), S(20, 35),
