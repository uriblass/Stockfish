...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Knight
   S(-101,-104), S(-80,-79),  S(-60,-55), S(-50,-42), S(-50,-42), S(-60,-55), S(-80,-79), S(-101,-104),
   S( -70, -79), S( -50,-55), S(-29,-30), S(-19,-17), S(-19,-17), S(-29,-30), S( -50,-55), S( -70, -79),
   S( -40, -55), S( -19,-30), S(  1, -6), S( 10,  5), S( 10,  5), S(  1, -6), S( -19,-30), S( -40, -55),
   S( -19, -42), S(   1,-17), S( 20,  5), S( 31, 18), S( 31, 18), S( 20,  5), S(   1,-17), S( -19, -42),
   S( -8, -42),  S(  10,-17), S( 31,  5), S( 41, 18), S( 41, 18), S( 31,  5), S(  10,-17),  S( -8, -42),
   S( -8, -55),  S(  10,-30), S( 31, -6), S( 41,  5), S( 41,  5), S( 31, -6), S(  10,-30),  S( -8, -55),
   S( -40, -79), S( -19,-55), S(  1,-30), S( 10,-17), S( 10,-17), S(  1,-30), S( -19,-55), S( -40, -79),
   S(-145,-104), S( -50,-79), S(-29,-55), S(-19,-42), S(-19,-42), S(-29,-55), S( -50,-79), S(-145,-104)
  },
  { // Bishop
   S(-30,-59), S(-30,-42), S(-26,-35), S(-22,-26), S(-22,-26), S(-26,-35), S(-30,-42), S(-30,-59),
   S(-13,-42), S(  0,-26), S( -3,-18), S(  0,-11), S(  0,-11), S( -3,-18), S(  0,-26), S(-13,-42),
   S(-10,-35), S( -3,-18), S(  6,-11), S(  3, -4), S(  3, -4), S(  6,-11), S( -3,-18), S(-10,-35),
   S( -6,-26), S(  0,-11), S(  3, -4), S( 13,  4), S( 13,  4), S(  3, -4), S(  0,-11), S( -6,-26),
   S( -6,-26), S(  0,-11), S(  3, -4), S( 13,  4), S( 13,  4), S(  3, -4), S(  0,-11), S( -6,-26),
   S(-10,-35), S( -3,-18), S(  6,-11), S(  3, -4), S(  3, -4), S(  6,-11), S( -3,-18), S(-10,-35),
   S(-13,-42), S(  0,-26), S( -3,-18), S(  0,-11), S(  0,-11), S( -3,-18), S(  0,-26), S(-13,-42),
   S(-13,-59), S(-13,-42), S(-10,-35), S( -6,-26), S( -6,-26), S(-10,-35), S(-13,-42), S(-13,-59)
  },
  { // Rook
